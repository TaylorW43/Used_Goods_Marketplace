...
<form method="post" action="seller_register.php">
    ...
    <div class="container">
        ...
        <!---<button type="button" class="registerbtn" onClick="return validation()">Register</button>--->
        <button type="submit" class="seller_registerbtn" name="seller_registerbtn">Register</button>
